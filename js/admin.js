...
async function saveProduct() {
    ...
    try {
        ...
        if (newVideoFile) { try { var uploadedVideoUrl = await uploadToCOS(newVideoFile, "videos"); if (uploadedVideoUrl) videoUrl = uploadedVideoUrl; } catch(e) { console.error('视频上传失败:', e); showToast('视频上传失败'); } }
